                   ...
                   <div class="col-md-6 col-lg-6 col-xl-3">
                       <div class="footer-item d-flex flex-column">
                           ...
                           <div class="footer-btn d-flex align-items-center">
                               ...
                               <a class="btn btn-secondary btn-md-square me-2"
                                   href="https://twitter.com/GreenGenesisEn3"><i
                                       class="fab fa-twitter text-white"></i></a>
                               <a class="btn btn-secondary btn-md-square me-2"
                                   href="https://www.instagram.com/greengenesisbd/"><i
                                       class="fab fa-instagram text-white"></i></a>
                               <a class="btn btn-secondary btn-md-square me-0"
                                   href="https://www.linkedin.com/company/green-genesis-engineering-ltd/"><i
               ...
               <div class="row g-4 align-items-center">
                   <div class="col-md-6 text-center text-md-start mb-md-0">
                       <span class="text-body"><a href={{Route('home')}} class="border-bottom text-white"><i
                                   class="fas fa-copyright text-light me-2"></i>Dynamic Product, </a> All right
                           reserved.</span>
                   </div>
                   <div class="col-md-6 text-center text-md-end text-body">
                       Designed By: <a class="border-bottom text-white" href={{Route('home')}}> Green Genesis
