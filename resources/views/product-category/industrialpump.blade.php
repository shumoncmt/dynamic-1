...
<section class="diff-offer-wrapper">
            <div class="container">
                <div class="row ">
                        <h2 style="margin-bottom:10px; margin-top:25px">Industrial Pump</h2>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 service-info">
            <div class="item"><a href={{Route('gksseriescentrifugalpump')}} class="post-image view image_hover">		<img src= "{{ asset('img/catagory/pump/gks-series-centrifugal-pump.jpg')}}" alt="" class="img-responsive zoom_img_effect"></a><a href={{Route('gksseriescentrifugalpump')}}>
